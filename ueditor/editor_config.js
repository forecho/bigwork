...
(function (){
    var URL= "http://localhost/com/ueditor/";                            //这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径
    UEDITOR_CONFIG = {
        imagePath : URL + "server/upload/",    //图片保存目录，需要与后台返回的图片地址数据配合！
...
//            'outdent':'取消缩进',
        ...
        ,
        initialContent: '<span style="color:#ccc"></span>',  //初始化编辑器的内容
